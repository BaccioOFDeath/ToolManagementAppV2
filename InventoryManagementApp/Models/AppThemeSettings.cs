...
namespace InventoryManagementApp.Models
{
    public class AppThemeSettings
    {
        ...
        public void Normalize()
        {
            ...
            BackgroundColor = NormalizeColor(BackgroundColor, CreateDefault(BaseTheme).BackgroundColor);
            SurfaceColor = NormalizeColor(SurfaceColor, CreateDefault(BaseTheme).SurfaceColor);
            SurfaceAltColor = NormalizeColor(SurfaceAltColor, CreateDefault(BaseTheme).SurfaceAltColor);
            TextColor = NormalizeColor(TextColor, CreateDefault(BaseTheme).TextColor);
            MutedTextColor = NormalizeColor(MutedTextColor, CreateDefault(BaseTheme).MutedTextColor);
            AccentColor = NormalizeColor(AccentColor, CreateDefault(BaseTheme).AccentColor);
            SuccessColor = NormalizeColor(SuccessColor, CreateDefault(BaseTheme).SuccessColor);
            WarningColor = NormalizeColor(WarningColor, CreateDefault(BaseTheme).WarningColor);
            ErrorColor = NormalizeColor(ErrorColor, CreateDefault(BaseTheme).ErrorColor);
        ...
        public AppThemeSettings Clone()
        {
            return new AppThemeSettings
            {
                ...
                SurfaceAltOpacity = SurfaceAltOpacity,
                ...
                UseGlassSurfaces = UseGlassSurfaces
            };
        }
