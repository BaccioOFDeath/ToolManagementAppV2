...
namespace InventoryManagementApp.Tests
{
    public class ManageRentalsViewModelTests
    {
        ...
        private sealed class StubRentalService : IRentalService
        {
            ...
            public Task<List<RentalModel>> GetActiveRentalsDueOnAsync(DateTime dueDate) => Task.FromResult(new List<RentalModel>());
            public Task<int> CountRentalsAsync() => Task.FromResult(_rentals.Count);
