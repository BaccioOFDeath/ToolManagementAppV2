...
namespace InventoryManagementApp.Tests.ViewModels
{
    public class MainViewModelAutoLogoutTests
    {
        ...
        class StubDialogService : IDialogService
        {
            ...
            public InventoryManagementApp.Models.Domain.ItemModel? ShowEditItemDialog(InventoryManagementApp.Models.Domain.ItemModel item) => null;
            public void ShowItemDetails(InventoryManagementApp.Models.Domain.ItemModel item) { }
            public (InventoryManagementApp.Models.Domain.CustomerModel customer, DateTime dueDate)? ShowRentItemDialog(InventoryManagementApp.Models.Domain.ItemModel item, System.Collections.Generic.IEnumerable<InventoryManagementApp.Models.Domain.CustomerModel> customers) => null;
