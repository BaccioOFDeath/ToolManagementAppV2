...
namespace InventoryManagementApp.Tests.ViewModels
{
    public class SettingsViewModelTests
    {
        ...
        public void PasswordIterations_AboveLimit_PersistsClampedValue()
        {
            ...
            try
            {
                var db = new InventoryManagementApp.Services.Core.DatabaseService(path);
                var settings = new InventoryManagementApp.Services.Settings.SettingsService(db);
                var dialog = new StubDialogService();
                var vm = new SettingsViewModel(new StubFileDialogService(), settings, dialog);
    ...
    class StubSettingsService : InventoryManagementApp.Interfaces.ISettingsService
    {
